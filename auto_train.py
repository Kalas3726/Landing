...
def main():
    ...
    parser.add_argument("--data_folder", type=str, help="Path to the folder of CSV files", default=r"D:\Ai_tennis\Landing\train_val_csv\dataset_0323") #, required=True
    parser.add_argument("--config_folder", type=str, help="Path to the folder containing config files", default=r"cfg\base") #这个不用改
    parser.add_argument("--output_folder", type=str, help="Path to save the trained models", default=r"D:\Ai_tennis\Landing\rough_landing_model\model_0323")
    parser.add_argument("--feature_number", type=int, default=18)
